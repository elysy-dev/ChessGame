...
class BoardTest {
    ...
    void pawnAdvancesUntilBlocked() {
        ...
        assertTrue(board.movePiece(1, 6, 1, 4), "W: First double move should be legal");

        // (6,1) -> (4,1)
        assertTrue(board.movePiece(2, 6, 2, 4), "B: First double move should be legal");

        // (1,4) -> (1,5)
        assertTrue(board.movePiece(1, 4, 2, 3), "W: move 2, capture paw");
        /*
